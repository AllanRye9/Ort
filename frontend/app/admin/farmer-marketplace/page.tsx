              ...
              <div className="flex flex-wrap items-center gap-3 p-3.5">
                ...
                <div className="flex items-center gap-1.5 flex-wrap">
                  {post.farmerId ? (
                    <a
                      href="/admin/kyc"
                      className="text-xs font-semibold px-2.5 py-1.5 rounded-lg border border-premium-navy/30 text-premium-navy hover:bg-premium-navy/5"
                    >
                      Review in KYC
                    </a>
                  ) : (
                  ...
                  {offersLoading === post.id ? (
                    ...
                    <div className="space-y-1.5">
                      {offersById[post.id].map((offer) => (
                        <div key={offer.id} className="flex flex-wrap items-center justify-between gap-2 bg-white rounded-lg border border-gray-100 px-3 py-2">
                          <p className="text-xs font-semibold text-gray-700 min-w-0">
                          ...
                          <div className="flex items-center gap-2 shrink-0">
                            ...
                            {offer.buyerId ? (
                              <a href="/admin/kyc" className="text-[11px] font-semibold px-2 py-1 rounded-md border border-premium-navy/30 text-premium-navy hover:bg-premium-navy/5">
                                Review in KYC
                              </a>
                            ) : (
                              <button
