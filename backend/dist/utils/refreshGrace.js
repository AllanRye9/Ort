...
exports.rememberRotatedRefresh = rememberRotatedRefresh;
exports.getRotatedRefresh = getRotatedRefresh;
const GRACE_WINDOW_MS = 15000;
const graceEntries = new Map();
/** Remembers the result of a token rotation, keyed by the OLD (now-superseded) refresh token. */
function rememberRotatedRefresh(oldRefreshToken, accessToken, newRefreshToken) {
    ...
    setTimeout(() => graceEntries.delete(oldRefreshToken), GRACE_WINDOW_MS + 1000).unref?.();
}
/** Looks up a just-superseded refresh token. Returns null if it was never rotated, or the grace window has passed. */
function getRotatedRefresh(oldRefreshToken) {
...
//# sourceMappingURL=refreshGrace.js.map