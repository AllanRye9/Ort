...
exports.optimizeImageInPlace = optimizeImageInPlace;
 ...
 */
async function optimizeImageInPlace(filePath, opts = {}) {
    ...
    try {
        ...
        const originalSize = fs_1.default.statSync(filePath).size;
        if (optimizedBuffer.length < originalSize) {
            fs_1.default.writeFileSync(filePath, optimizedBuffer);
        }
    }
    catch (err) {
        logger_1.logger.warn(`Image optimization skipped for "${filePath}": ${String(err)}`);
    }
}
